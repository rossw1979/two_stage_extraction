...
scout_result: {"page_layout": "双栏", "content_blocks": [{"type": "段落", "position": "左上", "complexity": "中"}, {"type": "段落", "position": "右上", "complexity": "中"}, {"type": "段落", "position": "右中", "complexity": "中"}, {"type": "图片", "position": "中央", "complexity": "高"}, {"type": "表格", "position": "左下", "complexity": "低"}], "tables": {"count": 1, "max_rows_estimate": 1, "has_merged_cells": false, "has_multiline_cells": true, "has_footnote_below": true}, "recommendation": "标准提取"}
total_time_seconds: 109.78
page_num: 38
task_id: 085714d6-d0b3-4151-ab4a-c693ade3923d
re_extracted: True
re_extract_focus: "遗漏了右栏中部的'Recommendation-Specific Supportive Text'段落（含关键OR/95%CI数据及研究年代说明），需补全该核心证据段落"
review_needed: True
review_reason: "遗漏了左下角的表格内容及表格下方注释，需补充提取Table 2及其相关说明"
---
...
The flowchart outlines the decision pathway for selecting between routine invasive and selective invasive strategies in patients with NSTE-ACS, based on initial risk stratification. High- or intermediate-risk patients proceed directly to routine invasive strategy (Class I), leading to PCI or CABG. Lower-risk patients may undergo either routine invasive strategy (Class I) or selective invasive strategy (Class I); the latter requires noninvasive risk stratification (e.g., stress testing or CCTA) or assessment of recurrent ischemic symptoms. Based on stratification results (+ or −), patients are directed either to revascularization (PCI/CABG) or to medical therapy alone, with a note to consider additional diagnostic workup for cases of MINOCA.
    ...
    - level_name: "Strategy Selection"
      nodes:
        ...
        - id: "node_4"
          ...
          recommendation: ""
          color_hint: "green"
    - level_name: "Noninvasive Risk Stratification"
      nodes:
        - id: "node_5"
          type: process
